use crate::utilities::mta::{range_proofs::tests::generate_init, MessageA, MessageB};
...
fn test_mta() {
	...
	let alpha = m_b.verify_proofs_get_alpha(&dk_alice, &alice_input).expect("wrong dlog or m_b");
